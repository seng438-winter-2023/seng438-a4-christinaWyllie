...
2. 157: Decremented (--a) double field lower (KILLED) (intersects())
3. 123: Incremented (a++) double field upper (SURVIVED) (getLength())
4. 114: Negated double field upper (KILLED) (getUpperBound())
5. 105: Incremented (a++) double field lower (SURVIVED) (getLowerBound())
6. 157: Negated double field lower (SURVIVED) (intersects())
7. 144: replaced boolean return with true (KILLED) (contains)
8. 144: negated double field lower (KILLED) (contains())
9. 123: negated douvle field upper (KILLED) (getLenght())
10. 105: netgated double field lower (KILLED) (getLowerBound())
...
- Insert Valid username but incorrect password
2. User Signup
- 
